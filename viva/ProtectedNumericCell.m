...
#import "ProtectedNumericCell.h"

#pragma .h #import <appkit/Cell.h>

@implementation ProtectedNumericCell:Cell
{
	id	mySubView;
}
...
- readRichText:(NXStream *)stream forView:view
{
	...
	[aString readFromText:mySubView];
	[self setFont:[mySubView font]];
...
//	height -= 8.0;
	theSize->width = [fontObj getWidthOf:[self stringValue]]+ [fontObj getWidthOf:"M"];
	theSize->height = lineHeight;
